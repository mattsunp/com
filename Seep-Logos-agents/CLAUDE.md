...
| エージェント | 起動条件キーワード |
|---|---|
| chief-producer | プロジェクト全体戦略、制作委員会設立、チーム組成、IP展開計画 |
| planning-developer | 企画書作成、新規IP立案、作品コンセプト、ピッチ資料 |
| production-committee-coordinator | 制作委員会、パートナー交渉、権利処理、スケジュール管理 |
| project-manager | 進行管理、タスク管理、マイルストーン、リスク管理 |

### 部門 2: クリエイティブ制作部
| エージェント | 起動条件キーワード |
|---|---|
| scenario-writer | シナリオ、脚本、ストーリー、セリフ、ゲームシナリオ |
| worldbuilding-creator | 世界観設定、設定資料集、用語集、地図、年表、種族設定 |
| original-work-developer | 原作開発、ノベル、小説、原案、原作执筆 |
| comic-creator | コミック、漫画、ネーム、コマ割り、吹き出し |
| audio-drama-producer | 朗読劇、音声劇、ラジオドラマ、台本、キャスト |

### 部門 3: アートディレクション部
| エージェント | 起動条件キーワード |
|---|---|
| art-director | アートディレクション、ビジュアル方針、スタイルガイド、世界観ビジュアル |
| game-ui-designer | ゲームUI、UIデザイン、UXデザイン、インターフェース設計 |
| background-art-creator | 美術背景、背景イラスト、背景設定、環境デザイン |
| visual-designer | デザイン制作、グラフィックデザイン、ロゴ、バナー、キービジュアル |

### 部門 4: マーケティングPR部
| エージェント | 起動条件キーワード |
|---|---|
| pr-communications | PR戦略、広報計画、メディア戦略、ブランドコミュニケーション |
| press-release-writer | プレスリリース、ニュースリリース、発表文、メディア向け文書 |
| sns-manager | SNS、Twitter（X）、Instagram、TikTok、YouTube、投稿文、ハッシュタグ |
| media-relations | メディア対応、取材対応、インタビュー、記者対応、メディアリスト |
| competitive-analyst | 競合調査、市場調査、トレンド分析、競合比較、業界動向 |

### 部門 5: 採用・クリエイター運用部
| エージェント | 起動条件キーワード |
|---|---|
| recruitment-strategist | 採用戦略、採用計画、人材要件、採用フロー設計 |
| recruitment-pr-writer | 採用広報、求人票、採用ページ、エンジニアブログ、クリエイター向け文章 |
| creator-relations | クリエイター管理、所属クリエイター、業務委託、契約、フリーランス対応 |
| internal-communications | 社内広報、社内報、インナーブランディング、社内コミュニケーション |

### 部門 6: デジタル・技術部
| エージェント | 起動条件キーワード |
|---|---|
| web-director | Webサイト制作、サイト設計、コンテンツ設計、LP制作 |
| game-dev-coordinator | ゲーム開発、開発チーム、仕様書、開発フロー |
| video-production-director | 動画制作、映像制作、PV、トレーラー、動画企画 |
| ui-engineering | ゲームUI実装、UIエンジニアリング、フロントエンド |

### 部門 7: ローカライズ・翻訳部
| エージェント | 起動条件キーワード |
|---|---|
| localization-director | ローカライズ戦略、海外展開、グローバル対応、多言語対応 |
...
### 全エージェント共通の出力形式
- タスクの冒頭に「担当エージェント：[部門名] / [エージェント名]」を明記
